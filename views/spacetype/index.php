        ...
        <div class="card-body table-border-style">
            <div class="table-responsive">
                ...
                <?= GridView::widget([
                    ...
                    'tableOptions' => ['class' => 'table', 'style' => 'text-align: center;'],
                    'columns' => [
                        ...
                        [
                            ...
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<button type="button" class="btn btn-sm btn-icon btn-link-info"><i class="fas fa-eye"></i></button>', $url);
                                },
                                'update' => function ($url, $model) {
                                    return Html::a('<button type="button" class="btn btn-sm btn-icon btn-link-success"><i class="far fa-edit"></i></button>', $url);
                                },
                                'delete' => function ($url, $model) {
                                    return Html::a('<button type="button" class="btn btn-sm btn-icon btn-link-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>', $url, ['data-confirm' => 'Are you sure you want to delete this space type?', 'data-method' => 'POST']);
                                },
                            ],
                        ],
                    ],
