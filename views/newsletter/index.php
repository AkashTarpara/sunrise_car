...
<div class="newsletter-index">
    <div class="card">
        <div class="card-header">
            ...
            <?= Html::a(Yii::t('app', 'Add News'), ['create'], ['class' => 'btn btn-sm btn-shadow btn-success float-end px-3']) ?>
        </div>
                            ...
                            'value' => function ($model) {
                                ...
                                return  '<div class="avatar">
                                            <a class="single_image" href="' . Yii::$app->params['ImagePath'] . $model->thumbnail_image . '">
                                                    <img src="' . Yii::$app->params['ImagePath'] . $model->thumbnail_image . '" class="img-avatar" style="width:50px;" alt="Image">    
                                            </a>                                   
                                        </div>';
                            },
                        ],
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                ...
                                return "<div class='form-check form-switch custom-switch-v1 mb-2'>
                                        <input type='checkbox' class='form-check-input input-warning statuschange' id='" . $model->newsletter_id . "'" . $checked . " value=" . $model->newsletter_id . ">
                                    </div>";
                                // return  "<div class='form-check form-switch custom-switch-v1 mb-2'>
                                //                 <input type='checkbox' class='form-check-input input-warning' data-toggle='switchbutton'".$checked." data-onstyle='success' data-offstyle='danger' class='status-switch' id=".$model->newsletter_id." value=".$model->newsletter_id.">
                                //             </div>";
                            },
                            'filter' => true,
                            ...
                            'buttons'  => [
                                ...
                                'delete'   => function ($url, $model) {
                                    return Html::a('<button type="button" class="btn btn-sm btn-icon btn-link-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
                                        ...
                                        'data-confirm' => 'Are you sure you want to delete this News?',
                                        'data-method' => 'POST'
                                    ]);
                                },
                            ],
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.statuschange').on('change', function() {
            ...
            $.ajax({
                url: '<?= Yii::$app->urlManager->createUrl(['newsletter/changestatus']) ?>',
                type: 'POST',
                data: {
                    id: $(this).val()
                },
