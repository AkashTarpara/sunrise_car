...
/** @var app\models\InstallationcomplexitySearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Installationcomplexities');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="installationcomplexity-index">
    <div class="card">
        <div class="card-header">
            <h5 class="float-start"><?= Html::encode($this->title) ?></h5>
            <?= Html::a(Yii::t('app', 'Create Installationcomplexity'), ['create'], ['class' => 'btn btn-sm btn-shadow btn-success float-end px-3']) ?>
        </div>
                            ...
                            'buttons'  => [
                                ...
                                'delete'   => function ($url, $model) {
                                    return Html::a('<button type="button" class="btn btn-sm btn-icon btn-link-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
                                        ...
                                        'data-confirm' => 'Are you sure you want to delete this complexity?',
                                        'data-method' => 'POST'
                                    ]);
                                },
                            ],
