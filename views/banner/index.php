...
<div class="banner-index">
    <div class="card">
        <div class="card-header">
            ...
            <?= Html::a(Yii::t('app', 'Add Banner'), ['create'], ['class' => 'btn btn-sm btn-shadow btn-success float-end px-3']) ?>
        </div>
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'headerOptions' => ['style' => 'min-width:150px; word-wrap: break-word; white-space: normal;'],
                            'contentOptions' => ['style' => 'word-wrap: break-word; white-space: normal;'],
                                ...
                                if ($model->type == 'Image') {
                                    return  '<div class="avatar">
                                                <a class="single_image" href="' . Yii::getAlias("@web") . "/" . $model->image . '">
                                                        <img src="' . Yii::getAlias("@web") . "/" . $model->image . '" class="img-avatar" style="width:50px;" alt="Image">    
                                                </a>                                   
                                            </div>';
                                } else {
                                    return  '<div class="avatar">
                        ...
                        [
                            ...
                            'value' => function ($model) use ($total) {
                                return "
                                <form id='form_" . $model->banner_id . "' action='" . Yii::$app->urlManager->createUrl(['banner/changeorder']) . "' method='POST'>
                                <input type='hidden' value='" . $total . "' name='total'>
                                <input type='hidden' value='" . $model->banner_id . "' name='id'>
                        ...
                        [
                            ...
                            'attribute' => 'Sequence',
                            'value' => function ($model) {
                                return  "<a href='javascript:;' class='btn btn-sm btn-light-info submit-order' id='" . $model->banner_id . "' >Change</a>";
                            },
                        ],
                        [
                            ...
                            'value' => function ($model) {
                                ...
                                return "<div class='form-check form-switch custom-switch-v1 mb-2'>
                                        <input type='checkbox' class='form-check-input input-warning statuschange' id='" . $model->banner_id . "'" . $checked . " value=" . $model->banner_id . ">
                                    </div>";
                            },
                            'filter' => true,
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.statuschange').on('change', function() {
            ...
            $.ajax({
                url: '<?= Yii::$app->urlManager->createUrl(['banner/changestatus']) ?>',
                type: 'POST',
                data: {
                    id: $(this).val()
                },
