...
/** @var app\models\ContentpageSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Pages');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="contentpage-index">
    <div class="card">
        <div class="card-header">
            <h5 class="float-start"><?= Html::encode($this->title) ?></h5>
            <?= Html::a(Yii::t('app', 'Add Page'), ['create'], ['class' => 'btn btn-sm btn-shadow btn-success float-end px-3']) ?>
        </div>
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                ...
                                return "<div class='form-check form-switch custom-switch-v1 mb-2'>
                                        <input type='checkbox' class='form-check-input input-warning statuschange' id='".$model->content_page_id."'".$checked." value=".$model->content_page_id.">
                                    </div>";
                            },
                            'filter' => true,
...
$(document).ready(function(){
    $('.statuschange').on('change', function() {
        ...
        $.ajax({
            url: '<?= Yii::$app->urlManager->createUrl(['contentpage/changestatus']) ?>',
            type: 'POST',
            data: {
                id:$(this).val()
            },
