...
<div class="productcategory-index">
    <div class="card">
        <div class="card-header">
            ...
            <?= Html::a(Yii::t('app', 'Add Category'), ['create'], ['class' => 'btn btn-sm btn-shadow btn-success float-end px-3']) ?>
        </div>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) use ($total) {
                                return "
                                <form id='form_" . $model->product_category_id . "' action='" . Yii::$app->urlManager->createUrl(['productcategory/changeorder']) . "' method='POST'>
                                <input type='hidden' value='" . $total . "' name='total'>
                                <input type='hidden' value='" . $model->product_category_id . "' name='id'>
                        ...
                        [
                            ...
                            'attribute' => 'Sequence',
                            'value' => function ($model) {
                                return  "<a href='javascript:;' class='btn btn-sm btn-light-info submit-order' id='" . $model->product_category_id . "' >Change</a>";
                            },
                        ],
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                ...
                                return "<div class='form-check form-switch custom-switch-v1 mb-2'>
                                        <input type='checkbox' class='form-check-input input-warning statuschange' id='" . $model->product_category_id . "'" . $checked . " value=" . $model->product_category_id . ">
                                    </div>";
                            },
                            'filter' => true,
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.statuschange').on('change', function() {
            ...
            $.ajax({
                url: '<?= Yii::$app->urlManager->createUrl(['productcategory/changestatus']) ?>',
                type: 'POST',
                data: {
                    id: $(this).val()
                },
