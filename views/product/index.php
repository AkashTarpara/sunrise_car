...
<div class="product-index">
    <div class="card">
        <div class="card-header">
            ...
            <?= Html::a(Yii::t('app', 'Add Product'), ['create'], ['class' => 'btn btn-sm btn-shadow btn-success float-end px-3']) ?>
        </div>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) use ($total) {
                                return "
                                <form id='form_" . $model->product_id . "' action='" . Yii::$app->urlManager->createUrl(['product/changeorder']) . "' method='POST'>
                        ...
                        [
                            ...
                            'attribute' => 'Sequence',
                            'value' => function ($model) {
                                return  "<a href='javascript:;' class='btn btn-sm btn-light-info submit-order' id='" . $model->product_id . "' >Change</a>";
                            },
                        ],
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                ...
                                return "<div class='form-check form-switch custom-switch-v1 mb-2'>
                                        <input type='checkbox' class='form-check-input input-warning statuschange' id='" . $model->product_id . "'" . $checked . " value=" . $model->product_id . ">
                                    </div>";
                            },
                            'filter' => true,
                        ...
                        [
                            ...
                            'buttons'  => [
                                ...
                                'copy'   => function ($url, $model) {
                                    return Html::a('<button type="button" class="btn btn-sm btn-icon btn-link-success" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
                                        title=" Copy "><i class="fas fa-copy"></i></button>', ['product/copy?id=' . $model->product_id]);
                                },
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.statuschange').on('change', function() {
            ...
            $.ajax({
                url: '<?= Yii::$app->urlManager->createUrl(['product/changestatus']) ?>',
                type: 'POST',
                data: {
                    id: $(this).val()
                },
