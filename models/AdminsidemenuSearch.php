...
/**
 * AdminsidemenuSearch represents the model behind the search form of `app\models\Adminsidemenu`.
 */
class AdminsidemenuSearch extends Adminsidemenu
{
    /**
     * {@inheritdoc}
     */
