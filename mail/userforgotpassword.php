...
if ($from == "user") {
    ...
    $resetLink = Yii::$app->urlManager->createAbsoluteUrl(['site/user-reset-password', 'token' => $user->password_reset_token]);
}
                    ...
                    <tr>
                        <td align="center" valign="top" bgcolor="#000000">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper" style="width:100%;padding-right: 0px;padding-left: 0px;">
                                <tr>
                                    <td style="line-height:1px; font-size:1px;" width="600"><a href="<?= $resetLink ?>" target="_blank"><img src="<?= Yii::$app->params['ImagePath'] ?>uploads/default/forgot_password_3.png" width="100%" alt="b1 OFFICE DESIGN" style="display:block; border:0px;" border="0"></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
