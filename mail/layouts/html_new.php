	...
	<tr>
    	<td valign="top" align="center">
        	<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper" style="width:600px;" bgcolor="#000000">
               ...
               <tr background="spasrk_headre.png">
                                            ...
                                            <td  align="center" valign="top" >
                                                <table width="560" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper" style="width:560px;">
                                                    <tr>
                                                        ...
                                                        <td width="550" align="left" valign="top" style="padding-top:15px;" class="padding_onn"><a href="#"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/logo_white.png" alt="Rajasthan Royals" width="50" style="display:block;width:50px;margin-bottom: 10px;" border="0"></a></td>
                                                    </tr>
                                                </table>                                    
                                            </td>
                                        </tr>
                                            ...
                                            <td  align="center" valign="top" style="padding-top:15px; padding-top:14px;">
                                                <table width="144" border="0" cellspacing="0" cellpadding="0" align="center" style="width:144px;">
                                                    <tr>
                                                      ...
                                                      <td align="left" valign="top" width="7"><a href="<?= $adminuser->facebook?>" target="_blank"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/fb_icon.png" alt="fb" width="7" height="12" style="display:block;" border="0"></a></td>
                                                        <td align="left" valign="top" width="10"></td>
                                                        
                                                  		<td align="left" valign="top" width="12"><a href="<?= $adminuser->twitter?>" target="_blank"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/tw_icon.png" alt="tw" width="12" height="12" style="display:block;" border="0"></a></td>
                                                        <td align="left" valign="top" width="9"></td>
                                                        
                                                      <td align="left" valign="top" width="15"><a href="<?= $adminuser->youtube?>" target="_blank"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/yt_icon.png" alt="yt" width="15" height="12" style="display:block;" border="0"></a></td>
                                                      <td align="left" valign="top" width="9"></td>
                                                      
                                                      <td align="left" valign="top" width="13"><a href="<?= $adminuser->snapchat?>" target="_blank"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/snapchat_icon.png" alt="snapchat" width="13" height="12" style="display:block;" border="0"></a></td>
                                                      <td align="left" valign="top" width="9"></td>
                                                      
                                                      <td align="left" valign="top" width="15"><a href="<?= $adminuser->instagram?>" target="_blank"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/insta_icon.png" alt="insta" width="15" height="12" style="display:block;" border="0"></a></td>
                                                      <td align="left" valign="top" width="9"></td>
                                                      
                                                      <td align="left" valign="top" width="15"><a href="<?= $adminuser->tiktok?>" target="_blank"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/playstore_icon.png" alt="playstore" width="13" height="12" style="display:block;" border="0"></a></td>
                                                      <td align="left" valign="top" width="9"></td>
                                                      
                                                      <td align="left" valign="top" width="12"><a href="<?= $adminuser->facebook?>" target="_blank"><img src="<?=Yii::$app->params['domain']?>uploads/images/default/email/apple_icon.png" alt="applestore" width="12" height="12" style="display:block;" border="0"></a></td>
                                                    </tr>
                                                </table>                                    
                                            </td>
                                        </tr>
